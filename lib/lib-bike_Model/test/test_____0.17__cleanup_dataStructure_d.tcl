...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    puts "\n -- bikeFrame -- mapping --\n"
        #
    foreach childNode [$dataRoot childNodes] {
        ...
        switch -exact $nodeName {
            ...
            TopTube {
                    ...
                    set nodeList [$childNode selectNodes */*]
                    foreach listNode $nodeList {
                        set xPath [string map {{/root/} {}} [$listNode toXPath]]
                        puts "       $nodeName:  $xPath ->  [$listNode asXML]"
                        set geometryValue [$listNode getAttribute geometryKey]
                        if {$geometryValue != {}} {
                            puts "                     -> geometryKey: $geometryValue"
                            $listNode setAttribute frameKey "$xPath"
                        }
                    }
