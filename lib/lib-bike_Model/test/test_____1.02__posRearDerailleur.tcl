...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    puts "[bikeModel::get__ObjectValue RearDropout Scalar Derailleur_X]"
    puts "[bikeModel::get__ObjectValue RearDropout Scalar Derailleur_Y]"
    puts "[bikeModel::get__ObjectValue RearDerailleur Position Origin]"
    bikeModel::set_Value RearDropout/Scalar/Derailleur_X 10
    bikeModel::set_Value RearDropout/Scalar/Derailleur_Y 34
    puts "[bikeModel::get__ObjectValue RearDropout Scalar Derailleur_X]"
    puts "[bikeModel::get__ObjectValue RearDropout Scalar Derailleur_Y]"
    puts "[bikeModel::get__ObjectValue RearDerailleur Position Origin]"
    exit
    ...
    set modelFile  [file join $BASE_Dir test ____3.4.05.00_model_xx.pureDict]    
