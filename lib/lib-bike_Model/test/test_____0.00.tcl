...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    lappend auto_path           [file join $BASE_Dir ..]
        ...
        # -- Packages  ---------------
    package require   bikeGeometry  2.00
    ...
    if 1 {
        puts "new init"
        bikeGeometry::initValues
    } else {
        puts "old init"
        bikeGeometry::initValues_1.x
    }
        #
    ...
    namespace eval test32 {    
            ...
            variable IF_OutsideIn   
            variable IF_LugAngles 
            variable IF_StackReach
            variable IF_Classic   
                #
                #
            set IF_OutsideIn    ::bikeGeometry::IF_OutsideIn
            ...
            foreach interFace [list $IF_OutsideIn $IF_LugAngles $IF_StackReach $IF_Classic] {
                puts "\n\n         --- $interFace --- \n"
    ...
    if 0 {
        ...
        compareValues    get_Component      {Label}                                     $::bikeGeometry::Component(Label)                                Component(Logo/File)                                ;# set _lastValue(Component/Logo/File)                                     
        ...
        compareValues    get_Position       {Saddle_Mount}                              $::bikeGeometry::Position(Saddle_Mount)                      
        ...
        compareValues    get_Scalar         {ChainStay HeightBB}                        $::bikeGeometry::ChainStay(HeightBB)                            FrameTubes(ChainStay/HeightBB)                      ;# set _lastValue(FrameTubes/ChainStay/HeightBB)                           
...
exit        
    ...
    ::bikeGeometry::IF_OutsideIn set_Scalar  CrankSet Q-Factor     180
    compareValues    get_Scalar             {CrankSet Q-Factor}                         $::bikeGeometry::CrankSet(Q-Factor)                             Component(CrankSet/Q-Factor)                        ;# set _lastValue(Component/CrankSet/Q-Factor)                             
    ...
    proc rattleCAD::control::set_Scalar {object key value} {::bikeGeometry::IF_OutsideIn set_Scalar ${object} ${key} ${value} }
    ...
    set bb_cs_Angle [::bikeGeometry::get_Scalar Geometry BottomBracket_Angle_ChainStay]
    puts "   <I> $bb_cs_Angle"
    
    
    puts "\n  ========================== \n"

    set retValue [bikeGeometry::IF_LugAngles set_Scalar Geometry BottomBracket_Angle_ChainStay 65]
    puts "   -> $retValue"

    
    puts "\n  ========================== \n"

    puts "         RearDropout OffsetCSPerp         [rattleCAD::control::set_Scalar  RearDropout OffsetCSPerp        377.0] "
    set retValue [bikeGeometry::IF_LugAngles set_Scalar Geometry BottomBracket_Angle_ChainStay 65]
    puts "   -> $retValue"
    
    puts "\n  ========================== \n"

    puts "         RearDropout OffsetCSPerp         [rattleCAD::control::set_Scalar  RearDropout OffsetCSPerp        0.0] "
    set retValue [bikeGeometry::IF_LugAngles set_Scalar Geometry BottomBracket_Angle_ChainStay 65]
    puts "   -> $retValue"
