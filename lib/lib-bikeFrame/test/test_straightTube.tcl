...
set WINDOW_Title      "test straightTube of bikeFrame, based on cad4tcl@rattleCAD"
...
source [file join $APPL_ROOT_Dir testTube classStraightTube.tcl] 
source [file join $APPL_ROOT_Dir testTube provideStraightTube.tcl] 
...
namespace eval control {
    ...
    variable arcPrecission         1
        ...
        #
    variable myTube             [bikeFrame::ProvideStraightTube new]
        #
}    
...
proc control::update {args} {
    ...
    set timeStart   [clock milliseconds]
        #
    set myTubeDict  [dict create]
    dict set myTubeDict Scalar { 
                                    Angle                     2.50
                                    LengthTaper             300.00
                                    DiameterST               28.60
                                    OffsetHT                  8.50
                                    DiameterHT               28.60
                                    MiterAngle_Origin        78.60
                                }
    $myTube updateShape    
            
        
        # $myTube setScalar   Angle          2.21
        # $myTube setScalar   DiameterHT    32.21
        # $myTube setScalar   DiameterST    28.21        
        # $myTube setScalar   Length       450.21
        # $myTube setScalar   LengthTaper  300.00 
        #
...
proc control::createTube {position} {
    ...
    $cvObject  create circle    $myPositon  [list -radius 1   -outline orange   -width 0.035    -tags __CenterLine__]
        #
        #
    set shape_XY  [$myTube getShape xy]
    set shape_XZ  [$myTube getShape xz]
        #
    set myPolygon       [vectormath::addVectorCoordList $pos_XY $shape_XY]
    $cvObject  create polygon   $myPolygon  [list -outline blue -fill gray80    -width 0.1      -tags __DebugShape__]
        #
    set myPolygon       [vectormath::addVectorCoordList $pos_XZ $shape_XZ]
    $cvObject  create polygon   $myPolygon  [list -outline blue -fill gray80    -width 0.1      -tags __DebugShape__]
