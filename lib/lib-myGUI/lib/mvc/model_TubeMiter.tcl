 ##+##########################################################################
 #
 # package: myGUI   ->  model_TubeMiter.tcl
 #
 ...
 #
 # ---------------------------------------------------------------------------
 #    namespace:  myGUI::model_TubeMiter
 # ---------------------------------------------------------------------------
 #
 #

    namespace eval myGUI::model::model_TubeMiter {
            #
        ...
        #
    proc myGUI::model::model_TubeMiter::setDictionary {key value} {
            #
        variable    Dictionary
        array set   Dictionary   [list $key $value]
            #
    }
    proc myGUI::model::model_TubeMiter::getDictionary {key} {
            #
        variable    Dictionary
