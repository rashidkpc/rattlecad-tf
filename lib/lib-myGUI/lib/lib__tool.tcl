 ...
 #
 # ---------------------------------------------------------------------------
 #    namespace:  myGUI::tool
 # ---------------------------------------------------------------------------
 #
 # 
 
 
namespace eval myGUI::tool {}

proc myGUI::tool::check_runTime {} {
...
proc myGUI::tool::toolException {command runTime} {
...
proc myGUI::tool::start_simplifySVG {} {
    puts "\n"
    puts "    start simplify_SVG.tcl: "
    puts "  ----------------------------------------"
    set command [file join $::APPL_Config(TOOL_Dir) simplify_SVG.tcl]
...
proc myGUI::tool::start_chainWheelSVG {} {
    puts "\n"
    puts "    start chainWheel_SVG.tcl: "
    puts "  ----------------------------------------"
    set command [file join $::APPL_Config(TOOL_Dir) chainWheel_SVG.tcl]
    set testDir [file join $::APPL_Config(USER_Dir) components/test ]
    puts "      -> $command"
    puts "      -> $testDir"
    puts ""
