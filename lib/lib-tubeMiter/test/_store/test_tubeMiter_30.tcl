...
##+######################
    ...
    proc model::miter_Cone {} {
        ...
        set miter_Cone          [lindex $list_Miter 0]   
        ...
        setValue /result/Miter_Cone             ${miter_Cone}
    ...
    proc model::miter_Cylinder_2 {} {
        ...
        set miterAngle      [getValue /result/Miter_Angle]
            #
        set precision       [getValue /settings/precision]
        set viewOffset      [getValue /settings/viewOffset]
            #
        set tubePerimeter   [expr $tubeDiameter * $vectormath::CONST_PI]
        set tubeRadius      [expr 0.5 * $tubeDiameter]
        set toolRadiusBase  [expr 0.5 * $baseDiameter]
        ...
        if {$control::tubeOffset >= 0} {
            set tubeSide {right}
            set tubeOffset $control::tubeOffset
        } else {
            set tubeSide {left}
            set tubeOffset [expr abs($control::tubeOffset)]
        }
        ...
        set miterAngle [vectormath::angle $direction {0 0} $direction_isect]
            #
        puts "<I> tubeMiter::cylinderMiter -> $toolRadiusBase $tubeRadius $miterAngle $tubeSide $tubeOffset $viewOffset"
            #
        set list_Miter [tubeMiter::cylinderMiter $toolRadiusBase $tubeRadius $miterAngle $tubeSide $tubeOffset $viewOffset]
    ...
    proc control::updateStage {{value {0}}} {
        ...
        $myCanvas  create line          $miterShape_Top     -tags {miterTop}    -fill blue      -width 1.0 
        ...
        $myCanvas  create line          $MiterView_TopDiam  -tags {miterViewTop}    -fill blue      -width 1.0 
            #
    ...
    proc view::create {windowTitle} {
            ...
            pack $f_settings.tooltype.type -side top  -fill x
