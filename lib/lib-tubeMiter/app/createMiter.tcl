...
set APP_ROOT_Dir       [file normalize [file dirname $argv0]]
    # set APP_Library_Dir    [file join $APP_ROOT_Dir tubeMiter]
...
lappend auto_path [file join $APP_BASE_Dir .. _ext__Libraries]
    #
...
package require tubeMiter
    ...
    #
    #
tubeMiter::app::createMiter::build .
    #
wm minsize .    [winfo width .] [winfo height .]    
    #
tubeMiter::app::createMiter::setExportDir   [file join $env(HOME) Documents]
tubeMiter::app::createMiter::setPDFViewer   abc
    #
    #
return
    #
