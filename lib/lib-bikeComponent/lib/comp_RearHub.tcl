 ...
 #
    ...
    oo::class create bikeComponent::RearHub {
        ...
        constructor {} {
            ...
            variable Position               
                ...
                #
                #
            variable myComponent        ; set myComponent [bikeComponent::bareRearHub new]
                #
            ### my update
                #                            
        }
        ...
        method update {} {
            ...
            set ComponentNode(XY_Disc)          [$myComponent getValue ComponentNode    XY_Disc]     
