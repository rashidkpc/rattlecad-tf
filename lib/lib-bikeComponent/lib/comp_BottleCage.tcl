 ##+##########################################################################te
 #
 # package: bikeComponent   ->  comp_BottleCage.tcl
 #
 ...
 #
    ...
    oo::class create bikeComponent::BottleCage {
        ...
        constructor {{orientation left}} {
            ...
            next
                #
            puts "              -> class BottleCage -> $orientation"
                #
            ...
            variable Position           ; array set Position {
                ...
                #
                #
            variable myComponent        ; set myComponent [bikeComponent::bareBottleCage new $orientation]
                #
            my update
                #                            
        }
        ...
        method update {} {
            ...
            $myComponent update
                #
            set Config(Type)        [$myComponent getValue Config       Type]  
                #
            set ComponentNode(XZ)   [$myComponent getValue ComponentNode XZ]   
                #
            set Position(End)       [vectormath::addVector  $Position(Origin)   [vectormath::rotatePoint {0 0}  [$myComponent getValue Position End]    $Direction(Origin)]]
                #
                # puts "  -> \$Position(End) $Position(End)"
                #
        }
            #
