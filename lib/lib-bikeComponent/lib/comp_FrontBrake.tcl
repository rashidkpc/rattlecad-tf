 ##+##########################################################################te
 #
 # package: bikeComponent   ->  comp_FrontBrake.tcl
 #
 ...
 #
 # ---------------------------------------------------------------------------
 #  namespace:  bikeComponent::FrontBrake      
 # ---------------------------------------------------------------------------
 #
 #

    oo::class create bikeComponent::FrontBrake {
        ...
        constructor {} {
            ...
            variable nodeSVG_Empty      ; set nodeSVG_Empty [my readSVGFile [file join $packageHomeDir components default_template.svg]]
                #
            variable myComponent        ; set myComponent   [bikeComponent::ComponentBasic  new FrontBrake]
                #
            ### my update
                #                            
        }
