...
namespace eval bikeGeometry::tube {
    ...
    proc bikeGeometry::tube::create_ForkBlade {valueDict} {
        ...
        set offsetDO  [vectormath::rotatePoint {0 0}           $addVector $dropOutAngle]
            ...
            # -- get oriented tube
        set outLine [vectormath::addVectorCoordList            $addVector $outLine]
        set outLine [vectormath::rotateCoordList               {0 0}  $outLine $angleRotation]
        set outLine [vectormath::addVectorCoordList            $dropOutPos $outLine]
            # puts "\$outLine       $outLine"    
        
            # -- get oriented centerLine
        set centerLineCut [vectormath::addVectorCoordList      $addVector [bikeGeometry::flatten_nestedList $centerLineCut]]
        set centerLineCut [vectormath::rotateCoordList {0 0}   $centerLineCut $angleRotation]
        set centerLineCut [vectormath::addVectorCoordList      $dropOutPos $centerLineCut]
            # puts "\$centerLineCut $centerLineCut"    

            # -- get oriented brakeDefLine
        set brakeDefLine [lrange $outLineRight 0 1]
        set brakeDefLine [vectormath::addVectorCoordList       $addVector [bikeGeometry::flatten_nestedList $brakeDefLine]]
        set brakeDefLine [vectormath::rotateCoordList          {0 0} $brakeDefLine $angleRotation]
        set brakeDefLine [vectormath::addVectorCoordList       $dropOutPos $brakeDefLine]
