        ...
        switch -exact $object {
            Geometry {
                    switch -exact $key {
                        ...
                        default {
                            puts "\n   -<W>- ::bikeGeometry::IF_LugAngles: Geometry $key ... not registered\n"
                        }
                    }
                }
            RearWheel {
                    switch -exact $key {
                        ...
                        default {
                            puts "\n   -<W>- ::bikeGeometry::IF_LugAngles: RearWheel $key ... not registered\n"
                        }
                    }
                }

            default {
                puts "\n   -<W>- ::bikeGeometry::IF_LugAngles: $object $key ... not registered\n"
            }
        }
            #
