...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    lappend auto_path           [file join $BASE_Dir ..]
        ...
        # -- Packages  ---------------
    package require   bikeGeometry  1.26
    ...
    # compareValues    get_Scalar     {Geometry FrontWheel_Diameter } $::bikeGeometry::Geometry(FrontWheel_Diameter)      Result(Length/FrontWheel/Diameter)        ;# set _lastValue(Result/Length/FrontWheel/Radius)                         
    # compareValues    get_Scalar     {Geometry RearWheel_Diameter  } $::bikeGeometry::Geometry(RearWheel_Diameter)       Result(Length/RearWheel/Diameter)        ;# set _lastValue(Result/Length/FrontWheel/Radius)                         
