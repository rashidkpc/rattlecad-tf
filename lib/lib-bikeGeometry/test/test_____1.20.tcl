...
set RearHub_Position    {600 50}
  ...
  # # exit      
    ...
    compareValue        get_Value   Custom/WheelPosition/Rear                           value                           get_Scalar          {Geometry ChainStay_Length}
                                                            
    compareValue        get_Value   Custom/BottomBracket/Depth                          value                           get_Scalar          {Geometry BottomBracket_Depth}
    ...
    compareValue        get_Value   Custom/HeadTube/Angle                               value                           get_Scalar          {Geometry HeadTube_Angle}
    ...
    compareValue        get_Value   Custom/TopTube/Angle                                value                           get_Scalar          {Geometry TopTube_Angle}
    ...
    compareValue        get_Value   Personal/HandleBar_Distance                         value                           get_Scalar          {Geometry HandleBar_Distance}
    compareValue        get_Value   Personal/HandleBar_Height                           value                           get_Scalar          {Geometry HandleBar_Height}
    compareValue        get_Value   Personal/Saddle_Distance                            value                           get_Scalar          {Geometry Saddle_Distance}
    compareValue        get_Value   Personal/Saddle_Height                              value                           get_Scalar          {Geometry Saddle_Height}
    compareValue        get_Value   Personal/InnerLeg_Length                            value                           get_Scalar          {Geometry Inseam_Length}
    # exit                                                        
    ...
    compareValue        get_Value   Result/Length/BottomBracket/Height                  value                           get_Scalar         {Geometry BottomBracket_Height}
    # exit
    ...
    compareValue        get_Dict    Custom/BottomBracket/Depth                          {}                              get_Scalar          {Geometry BottomBracket_Depth}
    ...
    compareValue        get_Dict    Custom/HeadTube/Angle                               {}                              get_Scalar          {Geometry HeadTube_Angle}
    ...
    # exit  
    compareValue        get_Dict    Custom/TopTube/Angle                                {}                              get_Scalar          {Geometry TopTube_Angle}
    ...
    compareValue        get_Dict    Custom/WheelPosition/Rear                           {}                              get_Scalar          {Geometry ChainStay_Length}
    ...
    compareValue        get_Dict    Personal/HandleBar_Distance                         {}                              get_Scalar          {Geometry HandleBar_Distance}
    compareValue        get_Dict    Personal/HandleBar_Height                           {}                              get_Scalar          {Geometry HandleBar_Height}
    compareValue        get_Dict    Personal/Saddle_Distance                            {}                              get_Scalar          {Geometry Saddle_Distance}
    compareValue        get_Dict    Personal/Saddle_Height                              {}                              get_Scalar          {Geometry Saddle_Height}
    compareValue        get_Dict    Personal/InnerLeg_Length                            {}                              get_Scalar          {Geometry Inseam_Length}    
    ...
    # exit
    compareValue        get_Dict    Result/Length/BottomBracket/Height                  {}                              get_Scalar          {Geometry BottomBracket_Height}
    compareValue        get_Dict    Result/Length/FrontWheel/Radius                     {}                              get_Scalar          {Geometry FrontWheel_Radius}
    ...
    compareValue        get_Dict    Result/Length/RearWheel/Radius                      {}                              get_Scalar          {Geometry RearWheel_Radius}
