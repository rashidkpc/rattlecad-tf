...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    lappend auto_path           [file join $BASE_Dir ..]
        ...
        # -- Packages  ---------------
    package require   bikeGeometry  1.24
    ...
    proc compareValues {procName argList compValue {projectXpath {_noXPath_}}} {
        ...
        switch -exact $procName {           
            ...
            #
        set compValue   [string range $compValue    0 70]
        set getterValue [string range $getterValue  0 70]
        set dictValue   [string range $dictValue    0 70]
        set xpathValue  [string range $xpathValue   0 70]
    ...
    compareValues    get_Position    {ForkCrown}                            $::bikeGeometry::Position(Steerer_Start)                        
    ...
    compareValues    get_Direction    {RearDropout}                         $::bikeGeometry::RearDropout(Direction) 
    compareValues    get_Direction    {ForkDropout}                         $::bikeGeometry::Fork(DropoutDirection) 
    compareValues    get_Direction    {ForkCrown}                           $::bikeGeometry::Fork(CrownDirection)         
    compareValues    get_Direction    {ChainStay}                           $::bikeGeometry::ChainStay(Direction)   
    compareValues    get_Direction    {DownTube}                            $::bikeGeometry::DownTube(Direction)    
    compareValues    get_Direction    {HeadTube}                            $::bikeGeometry::HeadTube(Direction)    
    compareValues    get_Direction    {SeatStay}                            $::bikeGeometry::SeatStay(Direction)    
    compareValues    get_Direction    {SeatTube}                            $::bikeGeometry::SeatTube(Direction)    
    compareValues    get_Direction    {Steerer}                             $::bikeGeometry::Steerer(Direction)     
    compareValues    get_Direction    {TopTube}                             $::bikeGeometry::TopTube(Direction)     
    ...
    compareValues    get_Polygon    {ChainStayRearMockup}                   $::bikeGeometry::Polygon(ChainStayRearMockup)
    ...
    compareValues    get_TubeMiter  {SeatTube_Down}                         $::bikeGeometry::TubeMiter(SeatTube_Down)          
    compareValues    get_TubeMiter  {SeatTube_BB_in}                        $::bikeGeometry::TubeMiter(SeatTube_BB_in)          
    compareValues    get_TubeMiter  {DownTube_Head}                         $::bikeGeometry::TubeMiter(DownTube_Head)          
    compareValues    get_TubeMiter  {DownTube_BB_in}                        $::bikeGeometry::TubeMiter(DownTube_BB_in)          
    compareValues    get_TubeMiter  {DownTube_BB_out}                       $::bikeGeometry::TubeMiter(DownTube_BB_out)          
    compareValues    get_TubeMiter  {TopTube_Head}                          $::bikeGeometry::TubeMiter(TopTube_Head)          
    compareValues    get_TubeMiter  {DownTube_Seat}                         $::bikeGeometry::TubeMiter(DownTube_Seat)          
    compareValues    get_TubeMiter  {SeatStay_01}                           $::bikeGeometry::TubeMiter(SeatStay_01)          
    compareValues    get_TubeMiter  {TopTube_Seat}                          $::bikeGeometry::TubeMiter(TopTube_Seat)          
    compareValues    get_TubeMiter  {SeatTube_BB_out}                       $::bikeGeometry::TubeMiter(SeatTube_BB_out)          
    compareValues    get_TubeMiter  {SeatStay_02}                           $::bikeGeometry::TubeMiter(SeatStay_02)          
    compareValues    get_TubeMiter  {Reference}                             $::bikeGeometry::TubeMiter(Reference)          
    ...
    reportComparison
        ...
        #
    # ::bikeGeometry::set_Config     {ChainStay}    bent
        #
    ...
    # compareValues    get_Position    {SummarySize}                          $::bikeGeometry::Geometry(SummarySize)    
